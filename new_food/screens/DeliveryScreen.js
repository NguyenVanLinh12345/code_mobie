    ...
    <View className="bg-[#00ccbb] flex-1">
      <SafeAreaView className="z-50">
        <View className="flex-row justify-between items-center p-5">
          ...
          <Text className="font-light text-white text-lg">Trang chủ</Text>
        </View>

        <View className="bg-white mx-5 my-2 rounded-md p-4 py-6 z-50 shadow-3xl">
          <View className="flex-row justify-between space-y-3">
            <View>
              <Text className="text-md text-gray-400">Hãy đợi nhé</Text>
              <Text className="text-3xl font-bold">Chúc bạn đặt hàng vui vẻ</Text>
            </View>
            <Image
          ...
          <Text className="mt-3 text-gray-500 text-sm">
            Đơn hàng {restaurant.title} Đang được khởi tạo
          </Text>
        </View>
      </SafeAreaView>
      ...
      <View className="bg-white flex-row items-center px-5 space-x-4 h-28">
        ...
        <View className="flex-1 ">
          <Text className="text-lg">Ứng dụng giao đồ ăn</Text>
          <Text className="text-gray-400">Tài xế giao hàng</Text>
        </View>
