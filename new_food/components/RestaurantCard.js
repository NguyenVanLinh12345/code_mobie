...
function RestaurantCard({ id, imgUrl, title, rating, genre, address, short_description, dishes, long, lat, }) {
    ...
    >
      ...
      <View className="px-3 pb-4 space-y-1">
        ...
        <View className="flex-row items-center space-x-1">
          ...
          <Text className="text-xs text-gray-500">Địa chỉ: {address}</Text>
        </View>
      </View>
    </TouchableOpacity>
  );
